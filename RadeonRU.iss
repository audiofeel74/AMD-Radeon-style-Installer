...
Source: "Unpack\russian.ini"; Flags: dontcopy
...
begin
  ...
  Page4Lbl[1].Text('Устанавливаем: ' + IntToStr(OverallPct div 10) + '% ');
...
begin
  ...
  begin
    ShowErrorForm('Дисковое пространство', 'Недостаточно свободного места', 'Освободите место на диске для продолжения установки или выберите другой путь!');
...
begin
  ...
  NextBtnLbl.FCreate(NextBtn.Handle, 'Далее');
  ...
  BackBtnLbl.FCreate(BackBtn.Handle, 'Назад');
  ...
  Page1Lbl[1].FCreate(Page1.Handle, 'Добро пожаловать в мастер установки {#GameName} Нажмите "Далее", чтобы продолжить установку');
  if FDark then
  ...
  Page1Lbl[2].FCreate(Page1.Handle, 'Перед продолжением установки рекомендуется закрыть другие приложения');
  ...
  Page2Lbl[1].FCreate(Page2.Handle, 'Игра будет установлена в указанное вами место на диске, а также создаст папку в "меню Пуск" и ярлыки в зависимости от вашего выбора');
  if FDark then
  ...
  Page2Lbl[2].FCreate(Page2.Handle, 'Чтобы продолжить, выберите необходимые задачи и нажмите кнопку "Далее"');
  ...
  Page2LayoutLbl[1].FCreate(Page2Layout.Handle, 'Место установки игры');
  if FDark then
  ...
  Page2LayoutBrowseBtnLbl.FCreate(Page2LayoutBrowseBtn.Handle, 'Обзор');
  ...
  Page2LayoutLbl[3].FCreate(Page2Layout.Handle, 'Свободное место: ');
  if FDark then
  ...
  Page2LayoutLbl[5].FCreate(Page2Layout.Handle, ' | Необходимое место: ');
  if FDark then
  ...
  Page2LayoutLbl[7].FCreate(Page2Layout.Handle, 'Не создавать папку в "меню Пуск"');
  if FDark then
  ...
  Page2LayoutLbl[8].FCreate(Page2Layout.Handle, 'Отключает создание папки игры');
  if FDark then
  ...
  Page2LayoutLbl[9].FCreate(Page2Layout.Handle, 'Ярлык на Рабочем столе');
  if FDark then
  ...
  Page2LayoutLbl[10].FCreate(Page2Layout.Handle, 'Создает ярлык запуска игры на Рабочем столе');
  if FDark then
  ...
  if FDark then
  begin
    DirBrowseForm.FCreateBlankForm($FF212121, 'Выберите папку', WizardForm.DirEdit.Text, '');
    DirBrowseForm.EditFontSettings('{#SemiBoldFont}', 12, $FFF5F5F5);
    DirBrowseForm.TextFontSettings('{#SemiBoldFont}', 16, $FFF5F5F5);
  end else
  begin
    DirBrowseForm.FCreateBlankForm($FFFFFFFF, 'Выберите папку', WizardForm.DirEdit.Text, '');
  ...
  DirBrowseCancelBtnLbl.FCreate(DirBrowseCancelBtn.Handle, 'Отмена');
  ...
  Page3Lbl[1].FCreate(Page3.Handle, 'Выберите все необходимые компоненты, которые вы хотите установить вместе с основной игрой');
  if FDark then
  ...
  Page3Lbl[2].FCreate(Page3.Handle, 'Чтобы начать установку, нажмите кнопку Установить и дождитесь завершения процесса');
  ...
  LangTileLayoutLbl.FCreate(LangTileLayout.Handle, 'Язык интерфейса:');
  if FDark then
  ...
  LangTile1Lbl[2].FCreate(LangTile1.Handle, 'Основной язык игры | ');
  if FDark then
  ...
  LangTile1Lbl[4].FCreate(LangTileLayout.Handle, 'Для этой игры не требуется');
  if FDark then
  ...
  LangTile2Lbl[2].FCreate(LangTile2.Handle, 'Основной язык игры | ');
  if FDark then
  ...
  CompoTileLayoutLbl.FCreate(CompoTileLayout.Handle, 'Компоненты:');
  if FDark then
  ...
  CompoTile1Lbl[2].FCreate(CompoTile1.Handle, 'Загружаемый контент | ');
  if FDark then
  ...
  CompoTile1Lbl[4].FCreate(CompoTileLayout.Handle, 'Для этой игры не требуется');
  if FDark then
  ...
  CompoTile2Lbl[2].FCreate(CompoTile2.Handle, 'Загружаемый контент | ');
  if FDark then
  ...
  RedistTileLayoutLbl.FCreate(RedistTileLayout.Handle, 'Распространяемые пакеты:');
  if FDark then
  ...
  RedistTile1Lbl[2].FCreate(RedistTile1.Handle, 'Загружаемый контент | ');
  if FDark then
  ...
  RedistTile1Lbl[4].FCreate(RedistTileLayout.Handle, 'Для этой игры не требуется');
  if FDark then
  ...
  Page4Lbl[1].FCreate(Page4.Handle, 'Установка: 00% ');
  if FDark then
  ...
  Page4Lbl[2].FCreate(Page4.Handle, 'Оставшееся время: ');
  if FDark then
  ...
  Page4Lbl[3].FCreate(Page4.Handle, '0 сек');
  if FDark then
  ...
  Page4Lbl[4].FCreate(Page4.Handle, 'Распаковка: ');
  if FDark then
  ...
  Page4Lbl[6].FCreate(Page4.Handle, 'Подождите, пока архивы распакуются, или нажмите "Отмена", чтобы выйти');
  ...
  Page5Lbl[1].FCreate(Page5.Handle, 'Запустить {#GameName}');
  ...
  Page5Lbl[2].FCreate(Page5.Handle, 'Запускает игру после выхода из установк');
  ...
  Page5Lbl[3].FCreate(Page5.Handle, 'Установка была успешно завершена. ');
  if FDark then
  ...
  Page5Lbl[4].FCreate(Page5.Handle, 'Время установки: ');
  if FDark then
  ...
  Page5Lbl[5].FCreate(Page5.Handle, '00 сек');
  if FDark then
  ...
  Page5Lbl[6].FCreate(Page5.Handle, 'Чтобы завершить установку, нажмите кнопку "Готово", и игра будет запущена, если вы установили флажок "Запустить"');
  ...
  ExitFormLbl[1].FCreate(ExitForm.Handle, 'Выход из программы установки');
  if FDark then
  ...
  ExitFormLbl[2].FCreate(ExitForm.Handle, 'Отменить установку?');
  if FDark then
  ...
  ExitFormLbl[3].FCreate(ExitForm.Handle, 'Вы уверены, что хотите выйти из установки {#GameName}?');
  if FDark then
  ...
  ExitFormBtnYesLbl.FCreate(ExitFormBtnYes.Handle, 'Да');
  if FDark then
  ...
  ExitFormBtnNoLbl.FCreate(ExitFormBtnNo.Handle, 'Нет');
  if FDark then
...
begin
  ...
  case CurPageID of
    ...
    begin
      ...
      BackBtn.Visible(False);
      NextBtnLbl.Text('Завершить');
      if ISArcExError then
      begin
        Page5CheckFrame.Visible(False);
        Page5Lbl[1].Visible(False);
        Page5Lbl[2].Visible(False);
        Page5Lbl[3].Text('Установка не удалась, произошла ошибка');
        Page5Lbl[6].Text('Чтобы завершить установку, нажмите кнопку "Готово"');
      end;
    end;
...
begin
  ...
  begin
    Page4Lbl[4].Text('Откат изменений...');
